...
- **First page**: Open with a greeting before introducing the interactive activity. If a student name is provided, greet them by name. Do NOT use generic plural terms like "同学们" (classmates/students). This is the ONLY page that should greet.
