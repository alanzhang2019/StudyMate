...
const PLANS: PlanCard[] = [
  ...
  {
    slug: '许立越',
    title: '许立越 · B 队 CSP-J 主力',
    subtitle: '初二 · AC 176 · 致命: 数据结构/字符串 0 题',
    badge: '🥈 B 队',
    tier: 'B',
    goal: 'CSP-J 2026 一等冲',
    topics: ['数据结构', 'KMP/哈希', '一次 AC 率'],
    description: '手感型选手但一次 AC 率仅 19%, 致命短板数据结构/字符串几乎 0 题。W0~国庆重点补 KMP + 并查集 + 线段树, 改掉"WA 后 84 秒重交"习惯。',
  },
  {
    slug: '林展骥',
...
const SHARED: PlanCard[] = [
  ...
  {
    slug: '2026-09-13加课-GESP8黄祺皓',
    title: '9/13 加课 · GESP 8 级临阵',
    subtitle: '黄祺皓 · 考前 3h 加课（与 9/12 GESP 6 级段平行）',
    badge: '⏰ 加课',
    tier: 'shared',
    goal: 'GESP 8 级保过 (≥60)',
  ...
  {
    slug: '2026-09-18加课-许立越',
    title: '9/18 加课 · 许立越 CSP-J 初赛冲刺',
    subtitle: '许立越 · 初赛倒计时 3 天 3h 临阵',
    badge: '⏰ 加课',
    tier: 'shared',
    goal: 'CSP-J 2026 第一轮 一等',
    topics: ['选择错 ≤ 5', '程序阅读', '栈/链表/KMP'],
    description: '9/18 加课: 选择题 12 考点串讲 (栈/队列/链表/排序/树) + KMP 概念扫盲 (0 题基础) + 历年程序阅读真题 4 道 (许立越死磕 TOP 4 道) + 真题 1 套限时模拟。重点: 不快速重交。',
  },
  {
    slug: '2026-09-18加课-许立轩',
    title: '9/18 加课 · 许立轩 CSP-J 初赛',
    subtitle: '许立轩 · B 队 CSP-J 主力 · 初赛倒计时 3 天 3h',
    badge: '⏰ 加课',
    tier: 'shared',
    goal: 'CSP-J 2026 第一轮 一等',
    topics: ['链表/队列/栈', '单调栈/单调队列', '程序阅读'],
    description: '9/18 加课: 选择题套路串讲 + 程序阅读 4 道真题 + 真题限时模拟 1 套。',
  },
  {
    slug: 'gesp6-林展骥-林珅熠',
    title: '练习卷 · GESP 6 级',
