...
- **First page**: Open with a greeting and course introduction. If a student name is provided in the profile, greet them by name. Do NOT use generic plural terms like "同学们" (classmates/students) if teaching a specific student. This is the ONLY page that should greet.
